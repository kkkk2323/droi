...
export function VsCodeIcon({ className = 'size-4' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 128 128">
      <path
        fill="#007ACC"
        d="M121.7 13.8 95.3 1.1c-3.1-1.3-6.7-.6-9.1 1.6L1.7 81.4c-2.1 2-2.1 5.3 0 7.3l7.1 6.4c1.8 1.6 4.5 1.8 6.5.4l93.8-71.1c3.5-2.6 8.5-.1 8.5 4.2v-.3c0-3.2-1.9-6.1-4.9-7.3z"
      />
      <path
        fill="#1F9CF0"
        d="m121.7 114.2-26.4 12.7c-3.1 1.5-6.7.8-9.1-1.6L1.7 46.6c-2.1-2-2.1-5.3 0-7.3l7.1-6.4c1.8-1.6 4.5-1.8 6.5-.4l93.8 71.1c3.5 2.6 8.5.1 8.5-4.2v.3c0 3.2-1.9 6.1-4.9 7.3z"
      />
      <path
        fill="url(#vscode-gradient)"
        d="M95.3 126.9c-3.4 1.5-7.3.6-9.8-2.3 3.2 3.2 8.5.9 8.5-3.3V6c0-4.2-5.3-6.5-8.5-3.3 2.5-2.9 6.4-3.8 9.8-2.3l26.4 12.7c3 1.4 5 4.5 5 7.9v86c0 3.4-2 6.5-5 7.9l-26.4 12.7z"
      />
      <defs>
        <linearGradient
          id="vscode-gradient"
...
export function IdeaIcon({ className = 'size-4' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 128 128">
      ...
      <path
        fill="url(#idea-c)"
        d="m50.2 106.7-35.8 13 7.5-26.3 9.7-32.6L5 51.8l16.9-46.3 38.3 4.5L99.7 58.4z"
      />
      <path d="M27.4 27.4h73.1v73.1H27.4z" />
      <path
        fill="#fff"
        d="M36.5 86.7h27.4v4.6H36.5zm13.7-45.1v-5h-13.6v5h3.8v17.3h-3.8v5h13.6v-5h-3.8V41.6zm13.1 22.6c-1.9 0-3.7-.4-5.4-1.2-1.4-.7-2.6-1.6-3.6-2.9l3.8-4.2c.7.8 1.5 1.5 2.4 2 .8.5 1.7.7 2.6.7 1.1 0 2-.3 2.7-1.1.6-.7.9-1.8.9-3.4V36.6h6.1v17.9c0 1.5-.2 2.9-.7 4.3-.4 1.2-1.1 2.3-2 3.2-.9.9-2 1.5-3.2 2-1.2.4-2.5.7-4 .7"
      />
      <defs>
        <linearGradient
          id="idea-a"
...
export function WebStormIcon({ className = 'size-4' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 128 128">
      <path
        fill="url(#ws-a)"
        d="m21.3 111.3-15.8-93.5 29.2-12.1 18.6 11.1 17.1-9.2 35.6 13.7-19.9 101.3z"
      />
      <path
        fill="url(#ws-b)"
        d="m122.5 45.1-15.1-37.3-27.4-2.3-42.3 40.7 11.4 52.4 21.3 14.9 52.2-31-12.8-24z"
      />
      <path fill="url(#ws-c)" d="m99.1 39.6 10.6 18.9 12.8-13.3-9.4-23.2z" />
      <path d="M27.4 27.4h73.1v73.1H27.4z" />
      <path
        fill="#fff"
        d="M36.5 86.7h27.4v4.6H36.5zm26-50.2-4.1 16-4.7-16h-4.6l-4.7 16-4.1-16h-6.1l7.8 27.4h5.1l4.5-15.9 4.4 15.9h5.2l7.8-27.4zm7.5 23.5 3.6-4.3c3.1 2.6 6.3 4.1 8.2 3.3 2.4 0 4-.9 4-2.6 0-1.5-.9-2.3-5.5-3.5-5.5-1.4-9.1-2.9-9.1-8.4 0-5 4-8.3 9.6-8.3 4.3 0 7.8 1.3 10.2 3.5l-3.1 4.6c-2.5-2-5-3.1-7.2-2.7-2.3 0-3.5 1-3.5 2.4 0 1.8 1.2 2.4 5.9 3.7 5.6 1.5 8.7 3.5 8.7 8.3 0 5.5-4.2 8.5-10.1 8.5-4.5.1-8.5-1.5-11.7-4.4"
      />
      <defs>
        <linearGradient
          id="ws-a"
