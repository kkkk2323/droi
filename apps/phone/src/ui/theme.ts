// The web Client's design tokens (src/renderer/src/styles/global.css),
...
const light = {
  ...
  // Status only: Tailwind's emerald-600 and amber-600, as the web Client uses them.
  success: '#009966',
  attention: '#dd7400',
...
const dark: Colors = {
  ...
  // Tailwind's emerald-400 and amber-400.
  success: '#00d492',
  attention: '#ffb900',
