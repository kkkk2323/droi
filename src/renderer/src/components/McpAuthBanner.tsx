    ...
    <div className="mx-auto max-w-3xl px-4">
      <div className="flex items-center gap-3 rounded-lg border border-amber-400/50 bg-amber-500/5 px-4 py-2.5">
        ...
        <a
          ...
          className="flex items-center gap-1 rounded-md bg-foreground px-2.5 py-1 text-xs font-medium text-background transition-all hover:bg-foreground/80 active:scale-[0.995]"
        >
          Authorize
